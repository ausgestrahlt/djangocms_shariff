    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_backend', models.BooleanField(default=False, verbose_name='Use the shariff backend')),
                ('orientation_choices', models.CharField(default=b'horizontal', max_length=10, verbose_name='orientation', choices=[(b'vertical', 'vertical'), (b'horizontal', 'horizontal')])),
                ('theme_choices', models.CharField(default=b'standard', max_length=8, verbose_name='theme', choices=[(b'standard', 'standard'), (b'grey', 'grey'), (b'white', 'white')])),
